...
# ============================================================
def optimize_team(team1, team2, total_players=20, team1_weight=1.0, team2_weight=1.0):
...
if __name__ == "__main__":
    ...
    # Define team weights (adjustable)
    team1_weight = 1.05  # Weight for KKR players
    team2_weight = 1.0  # Weight for RR players
