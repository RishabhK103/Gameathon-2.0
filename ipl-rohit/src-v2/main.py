...
def main(data_dir):
    ...
    # Optimize the Dream11 team using multi-objective optimization
    pareto_solutions = optimize_team(match_df, dream_team_file)
    
    return pareto_solutions

if __name__ == "__main__":
    # Parse command-line arguments
    parser = argparse.ArgumentParser(description="Dream11 Team Selection with Multi-Objective Optimization")
